...
class Ken_Controller_Plugin_ErrorControllerSelector extends Zend_Controller_Plugin_Abstract
{
    public function routeShutdown(Zend_Controller_Request_Abstract $request)
    {
        ...
        if ($front->getDispatcher()->isDispatchable($testRequest)) {
            ...
            Zend_Registry::get('logger')->debug(__METHOD__ . '(): set ErrorController:' . $request->getModuleName());
        }
    }
}
